...
export const CarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14 16.94V19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h12v.06" />
    <path d="M7 16.94V19" />
    <path d="M14.4 11H18a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-1.6" />
    <path d="m22 11-3-3" />
    <path d="M2 12V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v6" />
    <path d="M5 12H2.5" />
    <path d="M5 7H2.5" />
    <path d="M12 12h10" />
